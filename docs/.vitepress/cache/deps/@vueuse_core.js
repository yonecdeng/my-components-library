...
var __spreadValues$a = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$c.call(b, prop)) __defNormalProp$a(a, prop, b[prop]);
  if (__getOwnPropSymbols$c)
    for (var prop of __getOwnPropSymbols$c(b)) {
      if (__propIsEnum$c.call(b, prop)) __defNormalProp$a(a, prop, b[prop]);
    }
  return a;
};
    ...
    result[key] = customRef(() => ({
      ...
      set(v) {
        if (Array.isArray(objectRef.value)) {
          ...
          const newObject = __spreadProps$7(
            __spreadValues$9({}, objectRef.value),
            { [key]: v }
          );
...
function formatDate(date, formatStr, options = {}) {
  ...
  return formatStr.replace(REGEX_FORMAT, (match, $1) => {
    ...
    return (
      $1 ||
      ((_a2 = matches[match]) == null ? void 0 : _a2.call(matches)) ||
      match
    );
  });
}
...
var __spreadValues$p = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$s.call(b, prop)) __defNormalProp$p(a, prop, b[prop]);
  if (__getOwnPropSymbols$s)
    for (var prop of __getOwnPropSymbols$s(b)) {
      if (__propIsEnum$s.call(b, prop)) __defNormalProp$p(a, prop, b[prop]);
    }
  return a;
};
...
var __spreadValues$o = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$r.call(b, prop)) __defNormalProp$o(a, prop, b[prop]);
  if (__getOwnPropSymbols$r)
    for (var prop of __getOwnPropSymbols$r(b)) {
      if (__propIsEnum$r.call(b, prop)) __defNormalProp$o(a, prop, b[prop]);
    }
  return a;
};
...
function onKeyDown(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$b(__spreadValues$o({}, options), { eventName: 'keydown' })
  );
}
function onKeyPressed(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$b(__spreadValues$o({}, options), { eventName: 'keypress' })
  );
}
function onKeyUp(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$b(__spreadValues$o({}, options), { eventName: 'keyup' })
  );
}
...
var __spreadValues$n = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$q.call(b, prop)) __defNormalProp$n(a, prop, b[prop]);
  if (__getOwnPropSymbols$q)
    for (var prop of __getOwnPropSymbols$q(b)) {
      if (__propIsEnum$q.call(b, prop)) __defNormalProp$n(a, prop, b[prop]);
    }
  return a;
};
...
var __spreadValues$m = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$p.call(b, prop)) __defNormalProp$m(a, prop, b[prop]);
  if (__getOwnPropSymbols$p)
    for (var prop of __getOwnPropSymbols$p(b)) {
      if (__propIsEnum$p.call(b, prop)) __defNormalProp$m(a, prop, b[prop]);
    }
  return a;
};
...
var __spreadValues$l = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$o.call(b, prop)) __defNormalProp$l(a, prop, b[prop]);
  if (__getOwnPropSymbols$o)
    for (var prop of __getOwnPropSymbols$o(b)) {
      if (__propIsEnum$o.call(b, prop)) __defNormalProp$l(a, prop, b[prop]);
    }
  return a;
};
...
function useCloned(source, options = {}) {
  ...
  if (!manual && isRef(source)) {
    watch(
      source,
      sync,
      __spreadProps$9(__spreadValues$l({}, options), {
        deep,
        immediate
      })
    );
...
var __spreadValues$k = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$n.call(b, prop)) __defNormalProp$k(a, prop, b[prop]);
  if (__getOwnPropSymbols$n)
    for (var prop of __getOwnPropSymbols$n(b)) {
      if (__propIsEnum$n.call(b, prop)) __defNormalProp$k(a, prop, b[prop]);
    }
  return a;
};
...
var __spreadValues$j = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$m.call(b, prop)) __defNormalProp$j(a, prop, b[prop]);
  if (__getOwnPropSymbols$m)
    for (var prop of __getOwnPropSymbols$m(b)) {
      if (__propIsEnum$m.call(b, prop)) __defNormalProp$j(a, prop, b[prop]);
    }
  return a;
};
...
function useMutationObserver(target, callback, options = {}) {
  const _a = options,
    { window: window2 = defaultWindow } = _a,
    mutationOptions = __objRest$32(_a, ['window']);
  let observer;
  const isSupported = useSupported(
...
function useDark(options = {}) {
  ...
  const mode = useColorMode(
    __spreadProps$82(__spreadValues$i({}, options), {
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(
    source,
    __spreadProps$72(__spreadValues$h({}, options), {
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(
    source,
    __spreadProps$62(__spreadValues$g({}, options), { eventFilter: filter })
  );
...
function useResizeObserver(target, callback, options = {}) {
  const _a = options,
    { window: window2 = defaultWindow } = _a,
    observerOptions = __objRest$22(_a, ['window']);
  let observer;
  const isSupported = useSupported(
...
var __spreadValues$c = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$d2.call(b, prop)) __defNormalProp$c(a, prop, b[prop]);
  if (__getOwnPropSymbols$d2)
    for (var prop of __getOwnPropSymbols$d2(b)) {
      if (__propIsEnum$d2.call(b, prop)) __defNormalProp$c(a, prop, b[prop]);
    }
  return a;
};
var DEFAULT_OPTIONS = {
...
var __defNormalProp$b2 = (obj, key, value) =>
  key in obj
    ? __defProp$b2(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$b2 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$c2.call(b, prop)) __defNormalProp$b2(a, prop, b[prop]);
  if (__getOwnPropSymbols$c2)
    for (var prop of __getOwnPropSymbols$c2(b)) {
      if (__propIsEnum$c2.call(b, prop)) __defNormalProp$b2(a, prop, b[prop]);
    }
  return a;
};
function useFileSystemAccess(options = {}) {
  ...
  async function open(_options = {}) {
    ...
    const [handle] = await window2.showOpenFilePicker(
      __spreadValues$b2(__spreadValues$b2({}, toValue(options)), _options)
    );
  ...
  async function create(_options = {}) {
    ...
    fileHandle.value = await window2.showSaveFilePicker(
      __spreadValues$b2(__spreadValues$b2({}, options), _options)
    );
    data.value = void 0;
    await updateFile();
    await updateData();
...
var __defNormalProp$a2 = (obj, key, value) =>
  key in obj
    ? __defProp$a2(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$a2 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$b2.call(b, prop)) __defNormalProp$a2(a, prop, b[prop]);
  if (__getOwnPropSymbols$b2)
    for (var prop of __getOwnPropSymbols$b2(b)) {
      if (__propIsEnum$b2.call(b, prop)) __defNormalProp$a2(a, prop, b[prop]);
    }
  return a;
};
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  watch(() => [state.arrivedState[direction], toValue(element)], checkAndLoad, {
    immediate: true
  });
  return {
    isLoading
...
function usePerformanceObserver(options, callback) {
  const _a = options,
    { window: window2 = defaultWindow, immediate = true } = _a,
    performanceOptions = __objRest$12(_a, ['window', 'immediate']);
  const isSupported = useSupported(
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported.value) {
      const data = __spreadValues$52(
        __spreadValues$52({}, toValue(shareOptions)),
...
function useThrottledRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(
    source,
    __spreadProps$12(__spreadValues$32({}, options), { eventFilter: filter })
  );
...
function useTimeAgo(time, options = {}) {
  ...
  const _a = useNow({ interval: updateInterval, controls: true }),
    { now: now2 } = _a,
    controls = __objRest2(_a, ['now']);
  const timeAgo = computed(() =>
    formatTimeAgo(new Date(toValue(time)), options, toValue(now2.value))
  );
  if (exposeControls) {
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (passive) {
    ...
    watch(
      proxy,
      (v) => {
        if (v !== props[key] || deep) triggerEmit(v);
      },
      { deep }
    );
    return proxy;
